    ...
    <>
      ...
      <CCard>
        <CCardBody>
          <CRow>
            <CCol sm="5">
              <h4 id="traffic" className="card-title mb-0">Gráfico Estadístico</h4>
              <div className="small text-muted">Marzo 2021</div>
            </CCol>
              ...
              <table className="table table-hover table-outline mb-0 d-none d-sm-table">
                ...
                <tbody>
                  ...
                  <tr>
                    <td className="text-center">
                      <div className="c-avatar">
                        <img src={'avatars/9.jpg'} className="c-avatar-img" alt="admin@bootstrapmaster.com" />
                        <span className="c-avatar-status bg-danger"></span>
                      </div>
                    </td>
                    <td>
